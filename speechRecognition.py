...
class SpeechRecognition(object):
    ...
    def _update(self):
        ...
        if self._MyText == Keyword.Angry:
                self._commond = "Angry" 
        if self._MyText == Keyword.Message:
                self._commond = "Message" 
        if self._MyText == Keyword.Music:
                self._commond = "Music" 
        if self._MyText == Keyword.Play:
                self._commond = "Play" 
        if self._MyText == Keyword.Record:
                self._commond = "Record" 
        print (self._commond)
